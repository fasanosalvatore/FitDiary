...
export function ViewProtocolTitle(props) {
    return <Flex w="full" h="full" p={5} justifyContent={"space-between"} flexWrap={"wrap"}>
        ...
        <Flex ml={[0, 5]}>
            ...
            <Flex ml={[0, 5]}>
            <Heading size={"sx"} textAlign="center">Cliente:</Heading>
            <Text ml={2}>{props.protocollo.cliente.nome} {props.protocollo.cliente.cognome}</Text>
        </Flex>}
        <Flex>
